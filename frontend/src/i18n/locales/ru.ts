export const ru = {
  ...
  guide: {
    ...
    workout: {
      tag: "Тренировка",
      title: "Тренировка",
      body: "Запускай сессию и логируй каждый сет: вес, повторения и RIR — запас повторений. Под упражнением видно прошлый результат, цель на сегодня и кнопку «?» с техникой выполнения. Если день не из расписания, приложение переспросит перед стартом."
    },
    plans: {
      tag: "Планы",
      title: "Планы",
    ...
    progress: {
      tag: "Прогресс",
      title: "Прогресс",
      body: "Замеры тела и график веса, личные рекорды и календарь за 30 дней. В календаре зелёным отмечены тренировки по расписанию, голубым — дополнительные."
    },
    profile: {
      tag: "Профиль",
      title: "Профиль",
      body: "Личные данные, дни тренировок, тема оформления, язык и напоминания от бота. Выбранные дни недели задают расписание — по ним приходят напоминания. Этот гид всегда можно открыть отсюда снова."
    }
  },
  profile: {
    title: "Профиль",
