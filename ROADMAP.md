...
## Фаза 14. Гид по приложению (онбординг-тур) (P2) — 🟡 КОД ГОТОВ, ОЖИДАЕТ ПРОДА
...
### Тест
- [ ] Прод: первый вход после онбординга → появляется гид, листается, закрывается
- [ ] Кнопка «Открыть гид» в Профиле открывает его снова
- [ ] Закрыть/открыть Mini App → гид больше не появляется автоматически
